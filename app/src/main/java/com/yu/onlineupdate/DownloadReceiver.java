...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    private void checkStatus(Context context,Intent intent, int downloadId, DownloadManager downloadManager) {
        ...
        if (c.moveToFirst()) {
            ...
            switch (status) {
                ...
                case DownloadManager.STATUS_PAUSED:
                    Log.v("downloadFile", "下载暂停");
                    break;
                //下载延迟
                case DownloadManager.STATUS_PENDING:
                    Log.v("downloadFile", "下载延迟");
                    break;
                    //正在下载
                case DownloadManager.STATUS_RUNNING:
                    Log.v("downloadFile", "正在下载");
                    break;
                    //下载完成
                case DownloadManager.STATUS_SUCCESSFUL:
                    Log.v("downloadFile", "下载成功");
                    //下载完成安装apk
                    installApk(context,downloadId);
                    break;
                    //下载失败
                case DownloadManager.STATUS_FAILED:
                    Log.v("downloadFile", "下载失败");
                    break;
            }
        }
    }
